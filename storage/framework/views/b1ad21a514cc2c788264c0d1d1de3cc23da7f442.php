            ...
            <div class="flex flex-col w-4/5 px-0 mx-auto md:flex-row">
                ...
                <div class="flex flex-col w-full ml-0 lg:ml-12 lg:w-2/5 md:ml-12">
                    <div class="pt-12 md:pt-0 2xl:ps-4">
                        ...
                        <div>
                            <button onclick="swalfunc()" class="w-full inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md bg-[#e4bc84] border border-transparent rounded-md font-semibold text-xs text-black uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition">
...
<?php /**PATH E:\Github FIles\Kopiamo\resources\views/order/checkout.blade.php ENDPATH**/ ?>