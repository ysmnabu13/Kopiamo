                                    ...
                                    <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 mt-2 whitespace-nowrap text-sm font-medium">
                                                <!--a href="<?php echo e(route('review.show', $review->id)); ?>" class="text-blue-600 hover:text-blue-900 mb-2 mr-2">View Menu in Order</a-->
...
<?php endif; ?>
    ...
    <?php /**PATH E:\Github FIles\Kopiamo\resources\views/review/index.blade.php ENDPATH**/ ?>