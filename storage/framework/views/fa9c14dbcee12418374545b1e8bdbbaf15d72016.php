            ...
            <div class="flex flex-col w-4/5 px-0 mx-auto md:flex-row">
                ...
                <div class="flex flex-col w-full ml-0 lg:ml-12 lg:w-2/5 md:ml-12">
                    <div class="pt-12 md:pt-0 2xl:ps-4">
                        ...
                        <input name="total" value="<?php echo e($item->priceTotal()); ?>" hidden>
...
<?php /**PATH C:\Users\Fahmi ZB W\Documents\GitHub\Kopiamo\resources\views/order/checkout.blade.php ENDPATH**/ ?>