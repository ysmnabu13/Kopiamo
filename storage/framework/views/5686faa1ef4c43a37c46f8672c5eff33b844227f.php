...
<div class="bg-gray-200 w-full h-full py-5 flex justify-center items-center">
    <div class="relative pl-1 bg-gray-200 flex justify-center rounded-xl hover:scale-105 duration-500 transform transition cursor-pointer">
        <!-- Tag Discount -->
        <div class="top-0 left-0 mt-3 px-2 rounded-lg absolute z-30 bg-green-500 text-gray-100 text-xs md:text-sm font-medium md:block">11-21-2021</div>
        ...
        <div class="w-52 pb-2 bg-white rounded-xl shadow-xl z-10">
            ...
            <div class="px-2 py-1">
                <!-- Product Title -->
                <div class="text-sm md:text-base font-bold pr-2">My Review</div>
                <div class="flex py-2">
                ...
                <!-- Tombol pesan -->
                <a class="inset-x-0 bottom-0 flex justify-center bg-blue-500 hover:bg-white text-sm md:text-base border hover:border-2 hover:border-blue-500 rounded-xl w-14 md:w-16 p-1 text-gray-100 hover:text-blue-900" href="#">Back</a>
            </div>
        </div>
    </div> 
</div><?php /**PATH E:\Github FIles\AD\resources\views/review/reviewdetails.blade.php ENDPATH**/ ?>