                                    ...
                                    <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 mt-2 whitespace-nowrap text-sm font-medium">
                                                <a href="<?php echo e(route('review.show', $review->order_id)); ?>" class="text-blue-600 hover:text-blue-900 mb-2 mr-2">View Menu in Order</a>
                                        ...
                                        <div id="modal" class="fixed hidden z-50 inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4">
                                            <div class="relative top-40 mx-auto shadow-lg rounded-md bg-white max-w-md"-->
                                                ...
                                                <div class="flex justify-between items-center bg-yellow-800 text-white text-xl rounded-t-md px-4 py-2">
                                                    <h3>ORDER ID:<?php echo e($review->order_id); ?></h3>
                                                ...
                                                <div class="max-h-48 overflow-y-scroll p-4">
                                                    ...
                                                    <?php echo e($review->comment); ?><br/><br/>
                                                ...
                                                <?php $__currentLoopData = $orderitems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($items->order_id == $review->order_id): ?>
...
<?php endif; ?>
    ...
    <?php /**PATH C:\Users\Fahmi ZB W\Documents\GitHub\Kopiamo\resources\views/review/index.blade.php ENDPATH**/ ?>