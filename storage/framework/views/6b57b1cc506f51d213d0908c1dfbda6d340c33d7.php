...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-white leading-tight">
            <?php echo e(__('Welcome to Kopiamo')); ?>

        </h2>
     <?php $__env->endSlot(); ?>

    <div id="carouselExampleCaptions" class="carousel slide relative mb-10" data-bs-ride="carousel">
        ...
        <div class="carousel-inner relative w-full overflow-hidden">
          <div class="carousel-item active relative float-left w-full">
            <img
              src="<?php echo e(asset('uploads/welcome/1.png')); ?>"
              class="block w-full"
              alt="..."
            />
          ...
          <div class="carousel-item relative float-left w-full">
            <img
              src="<?php echo e(asset('uploads/welcome/2.png')); ?>"
              class="block w-full"
              alt="..."
            />
            <div class="carousel-caption hidden md:block absolute text-center">
          ...
          <div class="carousel-item relative float-left w-full">
            <img
              src="<?php echo e(asset('uploads/welcome/4.png')); ?>"
              class="block w-full"
              alt="..."
            />
            <div class="carousel-caption hidden md:block absolute text-center">
    ...
    <div class="container px-5 py-20 mx-auto flex flex-wrap">
        ...
        <div class="flex flex-wrap w-full bg-gray-100 py-32 px-10 relative mb-4">
            ...
            src="<?php echo e(asset('uploads/welcome/coffee-shop.png')); ?>">
            ...
            <a class="mt-3 text-indigo-500 inline-flex items-center" href="<?php echo e(route('menu.index')); ?>">Get Me There
...
<?php endif; ?>
<?php /**PATH C:\Users\Fahmi ZB\Documents\GitHub\Kopiamoo\resources\views/dashboard.blade.php ENDPATH**/ ?>