    ...
    <div>
        <div class="max-w-4xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="post" action="<?php echo e(route('menu.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\zulhu\Documents\GitHub\Kopiamo\resources\views/menu/create.blade.php ENDPATH**/ ?>